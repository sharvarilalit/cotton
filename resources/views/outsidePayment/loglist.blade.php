...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Outside Log Entries</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Outside Log Entries</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="myform" action='{{ route('oplog') }}' method="get"
                        >
                            <div class="row">
                                ...
                                <a href="{{ route('oplog') }}" class="btn btn-danger " id="reset"
                                    name="reset">Reset</a>
                            </div>
                        </form>
